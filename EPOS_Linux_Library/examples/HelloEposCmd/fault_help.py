...
def get_max_profile_velocity(key_handle):
    ...
    if epos.VCS_GetMaxProfileVelocity(key_handle, NODE_ID, ctypes.byref(max_vel), ctypes.byref(error_code)) != 0:
...
if __name__ == "__main__":
    ...
    # Set velocity mode & enable motor
    epos.VCS_SetOperationMode(key_handle, NODE_ID, ctypes.c_int(3), ctypes.byref(error_code))
    epos.VCS_SetState(key_handle, NODE_ID, 2, ctypes.byref(error_code))  # Switched On
